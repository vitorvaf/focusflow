...
namespace FocusFlow.Api.Migrations
{
    ...
    [Migration("20260330203838_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FocusFlow.Api.Models.Board", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FocusFlow.Api.Models.TaskItem", b =>
                {
                    b.HasOne("FocusFlow.Api.Models.Board", "Board")
                        .WithMany("Tasks")
            ...
            modelBuilder.Entity("TaskTag", b =>
                {
                    b.HasOne("FocusFlow.Api.Models.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FocusFlow.Api.Models.TaskItem", null)
                        .WithMany()
